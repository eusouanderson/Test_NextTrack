...
// Modifique a função handleSubmit para tratar erros específicos
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          ...
          <button
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-black px-5 py-2.5 rounded-lg shadow-md transition-colors duration-200 flex items-center gap-2"
          >
        ...
        <section className="mb-10">
          {isLoading ? (
            ...
            <div className="text-center py-10 bg-white rounded-lg shadow-sm">
              ...
              <button
                onClick={openCreateModal}
                className="mt-4 bg-indigo-600 hover:bg-indigo-700 text-black px-4 py-2 rounded-md text-sm font-medium"
              >
                Adicionar Contato
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {contacts.map((contact) => (
                <article key={contact.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200">
                  <div className="p-6">
                  ...
                  >
                    {isLoading ? (
                      <span className="flex items-center">
                        ...
                        {editingContact ? 'Atualizando...' : 'Salvando...'}
                      </span>
